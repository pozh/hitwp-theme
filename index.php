...
get_header(); ?>
	<header class="hero" id="scene" data-selector=".scene-child">
        ...
        <div class="container">
		<div class="hero__wrapper js-hero-content">
			<?php
			...
			printf( '<h1 class="hero__title js-hero-title">%s</h1>', $post_title );
			if ( !empty($post_caption))
				printf( '<h2 class="hero__caption js-hero-caption">%s</h2>', $post_caption );
